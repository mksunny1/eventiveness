 ...
 */
function addEventListener(element, event, listener, preventDefault) {
    let handling = false;
...
export { Fragment, actribute, addEventListener, apply, apriori, arender, eventivity, onEnter, querySelector, querySelectorAll, selectRules, sophistry };
