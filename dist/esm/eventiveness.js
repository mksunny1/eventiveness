 ...
 * @param {*} options 
 */
function addEventListener(elements, event, listener, options) {
    let handling = false;
...
export { Fragment, actribute, addEventListener, apply, applyAll, apriori, arender, eventivity, onEnter, preventDefault, querySelector, querySelectorAll, selectRules, sophistry, stopPropagation };
