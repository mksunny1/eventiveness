 ...
 * @returns 
 */
async function asyncLiteral(strings, ...expressions) {
 ...
 * @returns 
 */
function asyncTemplate(str, argNames, renderName) {
 ...
 * @returns 
 */
const createTree = function(markup) {
...
export { LastingFragment, apriori, asyncLiteral, asyncTemplate, createTree };
