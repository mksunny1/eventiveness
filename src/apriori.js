 ...
 * @returns 
 */
export function template(str, argNames) {
 ...
 * @returns 
 */
export function asyncTemplate(str, argNames, tagName) {
    if (!argNames) argNames = [];
 ...
 * @returns 
 */
export function arrayTemplate(str, argNames, itemName, itemSep) {
    if (!argNames) argNames = [];
 ...
 * @returns 
 */
export function arrayAsyncTemplate(str, argNames, itemName, itemSep, tagName) {
    if (!argNames) argNames = [];
    if (!itemName) itemName = 'item';
    if (!itemSep) itemSep = '';
    if (!tagName) tagName = 'T';
